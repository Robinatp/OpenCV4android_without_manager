...
public class CamParaUtil {
	private static final String TAG = "TFrobin_CamParaUtil";
	...
	public  Size getPropPreviewSize(List<Camera.Size> list, float th, int minWidth){
		...
		int i = 0;
		for(Size s:list){
			Log.i(TAG, "Size:w = " + s.width + " h = " + s.height +" minWidth ="+minWidth+" equalRate(s, th) = " +equalRate(s, th));
